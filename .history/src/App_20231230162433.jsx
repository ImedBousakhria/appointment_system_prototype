...
import { OPENING_TIME_MORNING, CLOSING_TIME_MORNING, OPENING_TIME_AFTERNOON, CLOSING_TIME_AFTERNOON, INTERVAL } from "./consts/config";
function App() {
  ...
  const afternoonTimes = getTimes(OPENING_TIME_AFTERNOON, CLOSING_TIME_AFTERNOON);
