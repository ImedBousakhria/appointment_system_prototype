...
export const Calendar = () => {
  ...
  // Form Handling
  // New states for form data and display
  ...
  const handleNextButtonTimeClick = () => {
    // Show the form when the next button is clicked
    setShowForm(true);
  };
  ...
  return (
    <div className=" flex flex-col">
      <div className="bg-slate-600 flex w-screen gap-6 justify-center">
        ...
        {showForm && (
        <div className="mt-3 bg-white flex flex-col justify-around px-3 py-2 rounded-md">
          ...
          <textarea
            ...
            className="mb-3"
          />
          <button onClick={handleFormSubmit} className="bg-blue-500 text-white p-2 rounded">
            Submit
          </button>
        </div>
      )}
