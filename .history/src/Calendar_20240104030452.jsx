...
export const Calendar = () => {
  ...
  const getTimes = (openingTime, closingTime) => {
    ...
    const beginningMorning = add(justDate, { hours: openingTime });
    const endMorning = add(justDate, { hours: closingTime });
    const beginningAfternoon = add(justDate, { hours: openingTime });
    const endAfternoon = add(justDate, { hours: closingTime });
