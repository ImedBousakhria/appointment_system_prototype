...
export const Calendar = () => {
  ...
  return (
    <div className=" bg-slate-600 max-h-min flex gap-6 justify-center">
      <ReactCalendar
        minDate={new Date()}
      ...
      />
      {date.justDate ? (
        <div className=" bg-white flex basis-[20%] overflow-visible flex-col justify-around pl-3 rounded-md ">
          {allTimes?.map((time, i) => (
            <div
              key={`time-${i}`}
              className=
