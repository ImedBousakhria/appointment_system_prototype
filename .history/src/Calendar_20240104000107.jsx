...
const DateSelection = ({ onSelectDate, onNext }) => (
  ...
  >
    ...
    />
    <button onClick={onNext} className="mt-3 bg-blue-500 text-white p-2 rounded">
      Next
    </button>
  </motion.div>
);
      ...
      <div className="">
        ...
        {showCalendar && !showTimeSelection && (
          ...
          >
            ...
            />
            <button onClick={handleNextButtonClick} className="mt-3 bg-blue-500 text-white p-2 rounded">
              Next
            </button>
            <button onClick={handleCalendarClose} className="mt-3 bg-red-500 text-white p-2 rounded">
              Close
            </button>
          </motion.div>
        )}
